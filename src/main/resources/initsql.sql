...
CREATE TABLE `virtualvault`          (id INTEGER AUTO_INCREMENT, name VARCHAR(10), user_id INT, balance DOUBLE, PRIMARY KEY(id), FOREIGN KEY (user_id) REFERENCES user(id) ON DELETE CASCADE);
...
INSERT INTO virtualvault (name, user_id, balance) VALUES
    ('Vault', 1, 200),
    ('Vacanza', 1, 300),
    ('Vault', 2, 500);
